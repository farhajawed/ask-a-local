$(document).ready(function() {
  ...
  function upsertCategory(categoryData) {
   ...
   function createCategoryRow(categoryData) {
    ...
    newTr.append("<td class='col-md-9 category-name'>" + categoryData.name + "</td>");
    newTr.append("<td class='col-md-3'><button class='btn btn-info mr-2 edit-category'><i class='far fa-edit'></i></button>"+
